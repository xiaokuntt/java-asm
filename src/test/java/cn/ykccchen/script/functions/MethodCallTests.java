...
public class MethodCallTests extends BaseTest {
	...
	public static void register() {
		...
		ResourceLoader.addModule("test", new DynamicModuleImport(SimpleDateFormat.class, (context) -> new SimpleDateFormat("yyyyMMdd")));
		ResourceLoader.addModule("method", new MethodCallTests());
	}
	...
	@Test
	@Ignore("Map-to-bean implicit conversion removed in current baseline")
	...
	@Test
	@Ignore("Map-to-bean varargs implicit conversion removed in current baseline")
