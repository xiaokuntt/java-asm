...
public class GrammarTests extends BaseTest {
	...
	public void new2Test() {
		Assert.assertTrue(execute("grammar/new_2.ms") instanceof ArrayList);
	}
	@Test
	public void new3Test() {
		Assert.assertTrue((Boolean) execute("grammar/new_3.ms"));
	}
	...
	public void forTest() {
		...
		Assert.assertEquals(2700, execute("grammar/for2.ms"));
		Assert.assertEquals(5400, execute("grammar/for3.ms"));
	}
	...
	public void switchTest() {
		Assert.assertEquals(2, execute("grammar/switch.ms"));
		Assert.assertEquals(100, execute("grammar/switch1.ms"));
		Assert.assertEquals(5, execute("grammar/switch2.ms"));
		Assert.assertEquals(3, execute("grammar/switch3.ms"));
	}

	@Test
	public void lambdaTest() {
//		Assert.assertEquals(8, execute("grammar/lambda.ms"));
		Assert.assertEquals(8, execute("grammar/lambda1.ms"));
	}
...
//		Assert.assertEquals("12666", execute("grammar/lambda_call_method_call.ms"));
		Assert.assertEquals("12666", execute("grammar/lambda_call_method_call2.ms"));
	}
	...
	public void while_1() {
		...
		Assert.assertEquals(5000, execute("grammar/while_2.ms"));
	}
